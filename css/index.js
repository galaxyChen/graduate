...
$('#t_14').bind('onmousedown',function()
{
	alert("活动尚未开始，敬请期待~")
	
})

$('#t_24').bind('onmousedown',function()
{
...
$('#t_34').bind('onmousedown',function()
{
	alert("活动尚未开始，敬请期待~")
	// 时光胶囊链接https://hemc.100steps.net/2016/time-capsule/
})
$('#t_44').bind('onmousedown',function()
{
	alert("活动尚未开始，敬请期待~")
	
})
$('#t_54').bind('onmousedown',function()
{
	alert("活动尚未开始，敬请期待~")
	
})
$('#t_64').bind('onmousedown',function()
{
	alert("活动尚未开始，敬请期待~")
